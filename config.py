...
APP_ID = int(os.environ.get("APP_ID", "23631217")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "567c6df308dc6901790309499f729d12") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002338165303")) #Your db channel Id
OWNER = os.environ.get("OWNER", "mimam_officialx") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "6139759254")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://rupper175:rupper175@cluster0.imf09ca.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "rupper175")
#--------------------------------------------
FSUB_LINK_EXPIRY = int(os.getenv("FSUB_LINK_EXPIRY", "-1002528229701"))  # 0 means no expiry
BAN_SUPPORT = os.environ.get("BAN_SUPPORT", "https://t.me/MRN_CONTACT_BOT")
TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "200"))
#--------------------------------------------
START_PIC = os.environ.get("START_PIC", "https://files.catbox.moe/ib13us.jpg")
